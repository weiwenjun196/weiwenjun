...
using namespace std;
string color,kch,kch_wuqi,record[100010],record_wuqi[100010];
...
void zhuangtai(bool x){
	if(!x) cout<<"\033[1;36m== ==当前状态〖角色〗== ==\033[0m"<<endl;
	else cout<<"\033[1;36m== ==当前状态〖武器〗== ==\033[0m"<<endl;
...
void record_output(bool x){
	if(!x){
		...
		if(!numtot_5xing_wuqi)
			cout<<"\033[1;36m//暂无记录//\033[0m"<<endl;
		for(i=0;i<=numtot_5xing_wuqi-1;i++){
